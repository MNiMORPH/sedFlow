...
#ifndef ENERGYSLOPETAU_H_
#define ENERGYSLOPETAU_H_
...
class EnergyslopeTau: public CalcTau {
private:
	bool correctionForBedloadWeightAtSteepSlopes;

public:
	EnergyslopeTau(bool correctionForBedloadWeightAtSteepSlopes);
	virtual ~EnergyslopeTau();
