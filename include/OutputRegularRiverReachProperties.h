...
#ifndef OUTPUTREGULARRIVERREACHPROPERTIES_H_
#define OUTPUTREGULARRIVERREACHPROPERTIES_H_
...
class OutputRegularRiverReachProperties: public OutputMethodType {
private:
...
#endif /* OUTPUTREGULARRIVERREACHPROPERTIES_H_ */
