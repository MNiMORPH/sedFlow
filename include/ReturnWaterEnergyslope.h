...
#ifndef RETURNWATERENERGYSLOPE_H_
#define RETURNWATERENERGYSLOPE_H_

#include "CalcGradient.h"

namespace SedFlow {

class ReturnWaterEnergyslope: public CalcGradient {
private:
	double minimumSlope;

public:
	ReturnWaterEnergyslope();
	ReturnWaterEnergyslope(double minimumSlope);
	virtual ~ReturnWaterEnergyslope();
...
#endif /* RETURNWATERENERGYSLOPE_H_ */
