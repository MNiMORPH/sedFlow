...
#ifndef SIMPLETHREECELLGRADIENT_H_
#define SIMPLETHREECELLGRADIENT_H_
...
class SimpleThreeCellGradient: public CalcGradient {
private:
...
public:
	SimpleThreeCellGradient(CombinerVariables::TypesOfRegularRiverReachProperties propertyOfInterest, CombinerVariables::TypesOfRegularRiverReachProperties weightingProperty);
	virtual ~SimpleThreeCellGradient(){}

	CalcGradient* createCalcGradientMethodPointerCopy() const;

	ConstructionVariables createConstructionVariables()const;

	double calculate (double upstreamValue, double downstreamValue, double upstreamLength, double localLength) const;
...
#endif /* SIMPLETHREECELLGRADIENT_H_ */
