/*
 * SimpleDownstreamTwoCellGradientWithCenteredValues.h
 *
...
#ifndef SIMPLEDOWNSTREAMTWOCELLGRADIENTWITHCENTEREDVALUES_H_
#define SIMPLEDOWNSTREAMTWOCELLGRADIENTWITHCENTEREDVALUES_H_

#include "CalcGradient.h"

namespace SedFlow {

class SimpleDownstreamTwoCellGradientWithCenteredValues: public CalcGradient {
private:
	CombinerVariables::TypesOfRegularRiverReachProperties propertyOfInterest;

public:
	SimpleDownstreamTwoCellGradientWithCenteredValues(CombinerVariables::TypesOfRegularRiverReachProperties propertyOfInterest);
	virtual ~SimpleDownstreamTwoCellGradientWithCenteredValues(){}

	CalcGradient* createCalcGradientMethodPointerCopy() const;

	ConstructionVariables createConstructionVariables()const;

	double calculate (double localValue, double downstreamValue, double localLength, double downstreamLength) const;
...
#endif /* SIMPLEDOWNSTREAMTWOCELLGRADIENTWITHCENTEREDVALUES_H_ */
